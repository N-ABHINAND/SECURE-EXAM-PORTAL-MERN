  ...
  return (
    <div className="grid">
      <div className="col-12">
        <div className="card">
          <div className="h1">Create Exam</div>
          <div className="h2">Admin only. This will be visible to students.</div>
          ...
          <div className="muted" style={{ marginBottom: 10 }}>
            Enter options one per line. Correct index starts from 0.
          </div>
            ...
            {questions.map((q, idx) => (
              <div key={idx} className="card" style={{ background: 'rgba(255,255,255,0.04)' }}>
                ...
                <div className="grid">
                  ...
                  <div className="col-6">
                    <Field label="Correct Index (0-based)">
                      <TextInput
                        type="number"
                        min={0}
